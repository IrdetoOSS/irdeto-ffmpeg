...
#define MOV_TIMECODE_FLAG_ALLOWNEGATIVE 0x0004
    ...
    MOVMuxCencContext cenc;// for MOV_ENC_CENC_AES_CTR and MOV_ENC_CENC_V3_AES_CTR
    MOVMuxCbcsContext cbcs;// for MOV_ENC_CBCS_AES_CBC
...
typedef enum {
    MOV_ENC_NONE = 0,
    /**
    * @brief The main difference between v1 and v2/v3 is that v1 subsample
    *        encryption skips non-vcl and nal header of vcl nal while v2/v3
    *        adds the skip of slice header of vcl nal.
    * @ref   ISO/IEC 23001-7 v3 Information technology — MPEG systems
    *        technologies — Part 7: Common encryption in ISO base media
    *        file format files.
    */
    MOV_ENC_CENC_AES_CTR,// CENC cenc scheme
    MOV_ENC_CENC_V3_AES_CTR,// Irdeto CENC cenc v3 scheme
    MOV_ENC_CBCS_AES_CBC,// Irdeto CENC cbcs v3 scheme
} MOVEncryptionScheme;
...
typedef struct MOVMuxContext {
    ...
    uint8_t encryption_iv[CBCS_IV_SIZE];// for pattern encryption cbcs
